# scripts/02_gen_embeddings_tinybert.py
import os
import torch
import gc
...
# ==========================================
# Changed to TinyBERT for comparison
MODEL_NAME = "huawei-noah/TinyBERT_General_4L_312D" 
MAX_LENGTH = 512        # Hard limit for positional embeddings

# Processing Settings (Same as DistilBERT run for fair comparison)
BATCH_SIZE = 256        # Stories per GPU forward pass
CHUNK_SIZE = 5000      # Stories saved per file

# LIMIT DATASET SIZE TO SAVE DISK SPACE
# Must match the limits used in the DistilBERT run for direct comparison
MAX_TRAIN_STORIES = 100000   # Limit Train set (e.g., 100k stories)
MAX_VAL_STORIES = 5000       # Limit Val set
...
def main():
    ...
    # Short name for filename (e.g., "tinybert-general-4l-312d")
